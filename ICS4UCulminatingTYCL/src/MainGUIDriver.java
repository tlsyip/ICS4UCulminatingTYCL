...
/**
 * JavaFx GUIDriver that acts as the main menu for card games "War" and "Old
 * Maid". This class gave selection to two games: Old Maid and War.
 */
public class MainGUIDriver extends Application {
	/**
	 * JavaFx starting point. Creates and displays the main menu and buttons to each
	 * game.
	 * 
	...
	public void start(Stage stage) throws Exception {
		...
		btnGameType1.setStyle("-fx-background-color: lightsteelblue; " + "-fx-border-color: black; "
				+ "-fx-border-width: 2;" + "-fx-text-fill: white;");
		btnGameType2.setStyle("-fx-background-color: moccasin; " + "-fx-border-color: black; " + "-fx-border-width: 2;"
	...
	/**
	 * Create the main scene This methods allow other drivers to switch back to the
	 * main menu.
	 * 
	 * @param stage the primary JavaFx stage
	...
	public static Scene startScene(Stage stage) {
		...
		btnGameType1.setStyle(
				"-fx-background-color: lightsteelblue; " + "-fx-border-color: black; " + "-fx-border-width: 2;");
		btnGameType2
				.setStyle("-fx-background-color: moccasin; " + "-fx-border-color: black; " + "-fx-border-width: 2;");
